...
public class BookStudy {
    public static void main(String[] args) {
        ...
        for(int i=0;i<book.length;i++) {
            ...
            System.out.print(i+"번째 책의 제목을 입력하세요: ");
            book[i].title=scan.nextLine();
            System.out.print(i+"번째 책의 지은이를 입력하세요: ");
            book[i].writer=scan.nextLine();
            System.out.print(i+"번째 책의 출판사를 입력하세요: ");
            book[i].company=scan.nextLine();
            System.out.print(i+"번째 책의 페이지수를 입력하세요: ");
            book[i].page=scan.nextInt();
            System.out.print(i+"번째 책의 가격을 입력하세요: ");
